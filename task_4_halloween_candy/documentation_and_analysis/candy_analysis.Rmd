...
candy <- read_csv(here("task_4_halloween_candy/clean_data/clean_candy_2015_to_2017.csv"))
```
...
The average age for the dataset is 42, which is not exactly the age we expect of trick and treaters and candy eaters. This also implies that older respondents were less likely to answer the question about whether they were going out!
